...
- **[CRITICAL - NO ONSEN]**: DO NOT include any recommendations or sections about "Nearby Onsen" or hot springs. Keep the focus entirely on the shrine and the journey.
    ...
    for i in range(TARGET_COUNT):
        ...
        try:
            ...
            if save_to_markdown(title, content, row, filename_slug):
                ...
                success_count += 1
                # time.sleep(5)  # 무료 API 사용 시 주석 해제
